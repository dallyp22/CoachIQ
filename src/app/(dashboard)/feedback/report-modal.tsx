...
/**
 * The Report form, shared by the button on /feedback and the floating button in
 * the app chrome. Two required fields; the page you're on, the app version, and
 * your browser are captured for you on submit — a report that asks for repro
 * steps up front is a report that never gets filed.
 */
export function ReportModal({ onClose }: { onClose: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    setErr(null);
    try {
      // The page they're on is the most useful context we can capture for free.
      const pageUrl =
